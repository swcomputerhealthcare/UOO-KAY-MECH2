...
function LTLogo() {
  return (
    <svg className="clientLogoImage" viewBox="0 0 290 60" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Monogram circle */}
      <circle cx="30" cy="30" r="24" fill="#14429E" />
      ...
      {/* Larsen & Toubro Text */}
      <text x="70" y="32" fontFamily="var(--font-heading)" fontSize="18" fontWeight="900" fill="#14429E" letterSpacing="1">LARSEN & TOUBRO</text>
...
function EmersonLogo() {
  return (
    <svg className="clientLogoImage" viewBox="0 0 220 60" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Globe Icon */}
      <circle cx="30" cy="30" r="24" stroke="#14429E" strokeWidth="3.5" fill="none" />
      <ellipse cx="30" cy="30" rx="14" ry="24" stroke="#14429E" strokeWidth="2" fill="none" />
      <ellipse cx="30" cy="30" rx="6" ry="24" stroke="#14429E" strokeWidth="1.5" fill="none" />
      <line x1="6" y1="30" x2="54" y2="30" stroke="#14429E" strokeWidth="2" />
      <path d="M12 18 C20 25, 40 25, 48 18" stroke="#14429E" strokeWidth="1.5" fill="none" />
      <path d="M12 42 C20 35, 40 35, 48 42" stroke="#14429E" strokeWidth="1.5" fill="none" />
      
      {/* Emerson lettermark */}
      <text x="72" y="36" fontFamily="var(--font-heading)" fontSize="22" fontWeight="900" fill="#14429E" letterSpacing="2.5">EMERSON</text>
...
function GodfreyLogo() {
  return (
    <svg className="clientLogoImage" viewBox="0 0 260 60" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Text */}
      <text x="65" y="32" fontFamily="var(--font-heading)" fontSize="17" fontWeight="900" fill="#14429E" letterSpacing="1">GODFREY PHILLIPS</text>
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h1 className="sectionTitle font-heading text-3xl sm:text-4xl lg:text-5xl font-bold text-[#14429E] uppercase tracking-wide cli-header-item">
            Industrial Clients
          </h1>
        </motion.div>
        ...
        <motion.div 
          className="bg-white text-[#14429E] border-t-2 border-[#14429E] p-8 sm:p-12 mb-20 cli-trust-banner clientsIntro"
        ...
        >
          <div className="max-w-3xl space-y-6">
            ...
            <h2 className="font-heading text-xl sm:text-2xl font-bold tracking-wide uppercase text-[#14429E]">
        ...
        <div className="mb-24">
          <motion.h3 
            className="font-heading text-xl font-bold text-[#14429E] uppercase tracking-wide mb-10 border-b border-[#D7DDE5] pb-3"
            initial={{ opacity: 0.01, y: 15 }}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 cli-logos-grid">
            {clients.map((c, idx) => (
              <motion.div
                ...
                whileHover={{
                  y: -4,
                  boxShadow: "0 16px 40px rgba(20, 66, 158,0.10)"
                }}
              >
        ...
        <div className="space-y-8">
          <motion.h3 
            className="font-heading text-xl font-bold text-[#14429E] uppercase tracking-wide border-b border-[#D7DDE5] pb-3"
            initial={{ opacity: 0.01, y: 15 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-80px" }}
            transition={{ duration: 0.55 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 font-sans">
            {clients.map((c, idx) => (
              ...
              >
                <div>
                  <h4 className="font-heading font-bold text-[#14429E] text-lg uppercase tracking-wide mb-2">
                    {c.name}
                  </h4>
