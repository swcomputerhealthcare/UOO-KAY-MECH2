...
function EmersonLogo() {
  return (
    <svg className="clientLogoImage" viewBox="0 0 220 60" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <line x1="6" y1="30" x2="54" y2="30" stroke="#161616" strokeWidth="2" />
      <text x="72" y="36" fontFamily="var(--font-heading)" fontSize="22" fontWeight="900" fill="#161616" letterSpacing="2.5">EMERSON</text>
