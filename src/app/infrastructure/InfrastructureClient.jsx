    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h1 className="sectionTitle font-heading text-3xl sm:text-4xl lg:text-5xl font-bold uppercase tracking-wide text-[#14429E]">
            Infrastructure
          </h1>
        </motion.div>
          ...
          <div className="lg:col-span-7 lg:sticky lg:top-28 console-detail-block">
            ...
            >
              ...
              <div className="pb-6 mb-6 border-b border-[#D7DDE5]">
                ...
                <h2 className="font-heading text-xl sm:text-2xl md:text-3xl font-bold uppercase text-[#14429E] leading-tight">
                  {activeAsset.name}
                </h2>
              </div>
