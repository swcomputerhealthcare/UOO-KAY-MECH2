...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="whatsappButton fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-40 bg-[#25D366] text-white p-3 sm:p-4 rounded-full shadow-2xl flex items-center justify-center premium-btn-hover hover:scale-110 transition-all duration-200"
